...
const DEFAULT_DIRS = [
  { id: uuid.v4(), body: "ひらめき", icon: "💡", color: "#F59E0B" },
  { id: uuid.v4(), body: "感情ログ", icon: "❤️", color: "#EF4444" },
  { id: uuid.v4(), body: "思考・問い", icon: "🧠", color: "#8B5CF6" },
  { id: uuid.v4(), body: "タスク・現在", icon: "⏰", color: "#3B82F6" },
  { id: uuid.v4(), body: "未来・計画", icon: "🌱", color: "#10B981" },
  { id: uuid.v4(), body: "過去・記憶", icon: "📜", color: "#6B7280" },
  { id: uuid.v4(), body: "学び・知識", icon: "🎓", color: "#0EA5E9" },
  { id: uuid.v4(), body: "自己観察", icon: "🪞", color: "#EC4899" },
  { id: uuid.v4(), body: "人間関係", icon: "👥", color: "#F97316" },
  { id: uuid.v4(), body: "Inbox", icon: "📥", color: "#64748B" }
];
